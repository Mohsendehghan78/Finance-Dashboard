...
export default function CartMoney() {
  ...
  return ( 
    // cart container 
    <div className=' xl:flex w-full justify-between  items-center gap-x-6 mt-10  '>
        {/* cart */}
        {carts.map(cart=>(
           <div className=' flex flex-col  justify-between items-center  mb-4 xl:mb-0 w-full  h-40 bg-white  text-Gray/900 rounded-3xl shadow-md  p-4'>
